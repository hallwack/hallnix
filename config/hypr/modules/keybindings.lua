...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_clipboard.sh"))
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_controlcenter.sh"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_theme.sh"))
...
hl.bind(mainMod .. " + A", function()
	...
	if not workspaces or not windows or not active_ws then
		return
	end
	local active_ids = {}
	...
	for _, ws_id in ipairs(active_ids) do
		if ws_id ~= target then
			...
			if ws_id == curr_ws_id then
				new_active_ws_id = target
			end
		end
		target = target + 1
	end
...
hl.bind(
	...
	hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_volume.sh up"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86AudioLowerVolume",
	hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_volume.sh down"),
	{ locked = true, repeating = true }
)
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_volume.sh mute"), { locked = true })
hl.bind(
	"XF86MonBrightnessUp",
	hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_brightness.sh up"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86MonBrightnessDown",
	hl.dsp.exec_cmd("/home/matteo/.local/bin/smart_brightness.sh down"),
	{ locked = true, repeating = true }
)
...
hl.bind(
	...
	hl.dsp.exec_cmd("/home/matteo/.local/bin/spotify_restart.sh"),
	{ locked = true }
)
